...
import LogoImage from "/src/assets/images/logo.jpeg";
      ...
      <div>
        {!isDashboardRoute && (
          <nav className="flex items-center justify-between h-14 3xl:h-28">
            {/* Logo and App Name */}
            <div className="flex items-center sm:ml-10 3xl:ml-16 2xl:ml-12">
              <img
                src={LogoImage}
                alt="Logo"
                className="h-12 w-20 rounded-md ml-2 3xl:w-44 3xl:h-24 3xl:mr-2"
              />
              <span className="text-2xl md:text-4xl lg:text-4xl italic font-bold ml-4 text-yellow-400">
                Electrify
              </span>
            </div>
